...
class partitions_tab(QtWidgets.QWidget):
    ...
    def reset_stateful_objects(self, side='both'):
        ...
        if left:
            self.PartitionListWidgetLeft.clear()
            self.PartitionListWidgetLeft.currentcontent = {}

        if right:
            self.PartitionListWidgetRight.clear()
            self.PartitionListWidgetRight.currentcontent = {}
